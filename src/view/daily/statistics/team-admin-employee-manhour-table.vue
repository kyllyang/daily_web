...
import { listStatisticsEmployeeManhourYear, pageStatisticsEmployeeManhourSelf } from '@/api/daily/statistics'
...
export default {
  ...
  methods: {
    ...
    loadYearList () {
      listStatisticsEmployeeManhourYear().then(res => {
    ...
    loadData () {
      ...
      pageStatisticsEmployeeManhourSelf({
